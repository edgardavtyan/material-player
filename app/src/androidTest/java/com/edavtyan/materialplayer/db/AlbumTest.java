...
public class AlbumTest extends BaseTest {
	...
	@Test public void equals_sameObject_true() {
	...
	@Test public void equals_firstTitleNotEqual_false() {
	...
	@Test public void equals_firstArtistTitleNotEqual_false() {
	...
	@Test public void equals_firstTracksCountNotEqual_false() {
		first.setTracksCount(0);
		assertThat(first.equals(second)).isFalse();
	}

	@Test public void equals_firstArtNotEqual_false() {
		first.setArt("title_not_equal");
		assertThat(first.equals(second)).isFalse();
	}

	@Test public void equals_firstArtNull_false() {
		first.setArt(null);
		assertThat(first.equals(second)).isFalse();
	}

	@Test public void equals_secondArtNull_false() {
		second.setArt(null);
		assertThat(first.equals(second)).isFalse();
	}

	@Test public void equals_bothArtsNull_true() {
		first.setArt(null);
		second.setArt(null);
		assertThat(first.equals(second)).isTrue();
	}
	...
	@Test public void equals_secondArtistNull_false() {
		assertThat(first.equals(null)).isFalse();
	}

	@SuppressWarnings("EqualsBetweenInconvertibleTypes")
	@Test public void equals_secondNotInstanceOfAlbum_false() {
	...
	@Test public void hashCode_nullArt_equalHashCodes() {
		first.setArt(null);
		second.setArt(null);
		assertThat(first.hashCode()).isEqualTo(second.hashCode());
	}
