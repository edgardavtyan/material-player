...
public class ArtistTest extends BaseTest {
	...
	@Test
	public void equals_titleNull_false() {
		first.setTitle(null);
		assertThat(first.equals(second)).isFalse();
	}
	...
	@Test
	public void equals_albumsCountNotEqual_false() {
		first.setAlbumsCount(2);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_tracksCountNotEqual_false() {
	...
	@Test
	public void equals_notInstanceOfArtist_false() {
		String string = "";
