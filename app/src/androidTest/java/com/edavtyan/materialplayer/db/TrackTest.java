...
public class TrackTest extends BaseTest {
	...
	@Test
	public void equals_trackNotEqual_false() {
		second.setTrack(2);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_titleNotEqual_false() {
	...
	@Test
	public void equals_pathNotEqual_false() {
	...
	@Test
	public void equals_firstPathNull_false() {
		first.setPath(null);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_secondPathNull_false() {
		second.setPath(null);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_bothPathsNull_true() {
		first.setPath(null);
		second.setPath(null);
		assertThat(first.equals(second)).isTrue();
	}
	...
	@Test
	public void equals_dateNotEqual_false() {
		first.setDateModified(1L);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_durationNotEqual_false() {
		first.setDuration(1L);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_artistIdNotEqual_false() {
		first.setArtistId(1);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_artistTitleNotEqual_false() {
	...
	@Test
	public void equals_albumIdNotEqual_false() {
		first.setAlbumId(1);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_albumTitleNotEqual_false() {
		first.setAlbumTitle("second");
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_firstAlbumTitleNull_false() {
		first.setAlbumTitle(null);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_secondAlbumTitleNull_false() {
		second.setAlbumTitle(null);
		assertThat(first.equals(second)).isFalse();
	}

	@Test
	public void equals_bothAlbumTitlesNull_true() {
		first.setAlbumTitle(null);
		second.setAlbumTitle(null);
		assertThat(first.equals(second)).isTrue();
	}
	...
	@Test
	public void equals_queueIndexNotEqual_false() {
	...
	@Test
	public void equals_firstArtistNull_false() {
	...
	@Test
	public void hashCode_equalTracks_equalHashCodes() {
	...
	@Test
	public void hashCode_nullPath_equalHashCodes() {
		first.setPath(null);
		second.setPath(null);
		assertThat(first.hashCode()).isEqualTo(second.hashCode());
	}
	...
	@Test
	public void hashCode_nullAlbumTitle_equalHashCode() {
		first.setAlbumTitle(null);
		second.setAlbumTitle(null);
		assertThat(first.hashCode()).isEqualTo(second.hashCode());
	}
