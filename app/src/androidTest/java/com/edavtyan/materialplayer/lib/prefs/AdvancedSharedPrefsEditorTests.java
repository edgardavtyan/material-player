...
public class AdvancedSharedPrefsEditorTests extends BaseTest {
	...
	@Test
	public void apply_applyBaseEditor() {
		editor.apply();
		verify(baseEditor).apply();
	}

	@Test
	public void commit_commitBaseEditor() {
		editor.commit();
