...
public class ArtistsListAdapter extends RecyclerViewCursorAdapter<ArtistsListAdapter.ArtistViewHolder> {
	...
	public class ArtistViewHolder
		...
		public void onClick(View view) {
			...
			Intent i = new Intent(itemView.getContext(), ArtistDetailActivity.class);
